          ...
          <div className="lg:w-[55%] p-12 lg:p-24 flex flex-col justify-center">
            ...
            <form className="space-y-10">
               <div className="flex flex-col gap-3">
                  ...
                  <div className="relative group">
                     ...
                     <input type="text" placeholder="e.g. Johnathan Doe" className="w-full border border-slate-100 bg-slate-50 p-6 pl-16 rounded-[1.5rem] focus:outline-none focus:border-teal-500 focus:bg-white focus:shadow-2xl focus:shadow-teal-500/10 transition-all font-black text-slate-800 placeholder:text-slate-200 text-xl" />
                  </div>
               </div>
               ...
               <div className="flex flex-col gap-3">
                  ...
                  <div className="relative group">
                     ...
                     <input type="email" placeholder="john@example.com" className="w-full border border-slate-100 bg-slate-50 p-6 pl-16 rounded-[1.5rem] focus:outline-none focus:border-blue-500 focus:bg-white focus:shadow-2xl focus:shadow-blue-500/10 transition-all font-black text-slate-800 placeholder:text-slate-200 text-xl" />
                  </div>
               </div>
               ...
               <div className="flex flex-col gap-3">
                  ...
                  <div className="relative group">
                     ...
                     <input type="password" placeholder="••••••••••••" className="w-full border border-slate-100 bg-slate-50 p-6 pl-16 rounded-[1.5rem] focus:outline-none focus:border-slate-900 focus:bg-white focus:shadow-2xl focus:shadow-slate-900/10 transition-all font-black text-slate-800 placeholder:text-slate-200 text-xl" />
                  </div>
               </div>

               <div className="flex items-center gap-4 py-2">
                  <input type="checkbox" className="w-6 h-6 accent-teal-600 rounded-xl cursor-pointer border-slate-200" id="terms" />
               ...
               <button className="w-full bg-slate-900 hover:bg-blue-600 text-white p-7 rounded-[2rem] font-black text-2xl transition-all shadow-2xl shadow-slate-950/20 active:scale-95 group flex items-center justify-center gap-4">
                  Complete Registration
                  <span className="w-10 h-10 bg-white/10 rounded-xl flex items-center justify-center group-hover:translate-x-2 transition-transform text-2xl">→</span>
               </button>
            </form>
            ...
            <div className="mt-14 text-center flex flex-col items-center gap-8">
               <p className="text-slate-400 font-bold text-lg tracking-tight">
                  Already have an account? <a href="#" className="text-teal-600 hover:text-blue-600 font-black decoration-4 underline-offset-8 underline transition-all">Log in here</a>
               </p>
